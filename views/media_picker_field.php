 ...
 */
?>
<div id="<?php echo $field_settings['id']; ?>-modal" class="modal acf-imp-browse-modal fade" tabindex="-1" role="dialog" data-target-input="<?php echo $field_settings['id']; ?>">
...
<button type="button" class="button acf-imp-button acf-imp-button-browse" data-toggle="modal" data-target="#<?php echo $field_settings['id']; ?>-modal"
        data-items-num="<?php echo esc_attr( $field_settings['media_limit'] ); ?>" data-media-type="<?php echo esc_attr( $field_settings['media_type'] ); ?>">
	<?php echo $field_settings['browse_button_label']; ?>
</button>

<input type="hidden" id="<?php echo $field_settings['id']; ?>" name="<?php echo esc_attr( $field_settings['name'] ); ?>" value="<?php echo esc_attr( $field_settings['value'] ); ?>" />